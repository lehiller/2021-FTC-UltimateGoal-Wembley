...
public class Camera {
    ...
    public ElementType detect() {

        ElementType type = ElementType.NONE;

        if (!Robot.opMode.isStarted()) {
            while (!Robot.opMode.isStarted()) {
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        } else if (updatedRecognitions.get(0).getLabel().contains("Q")) {
                        ...
                        Robot.telemetry.addLine("detected " + type);
    ...
    private void initVuforia() {
        ...
        parameters.cameraName = Robot.hw.get(WebcamName.class, "Webcam 1");
    ...
    private void initTfod() {
        int tfodMonitorViewId = Robot.hw.appContext.getResources().getIdentifier(
                "tfodMonitorViewId", "id", Robot.hw.appContext.getPackageName());
